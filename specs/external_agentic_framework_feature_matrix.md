...
GitHub stars snapshot: 2026-02-20 00:20:45 UTC
...
| 2 | LlamaIndex | `run-llama/llama_index` | 47,070 | Yes |
...
| 10 | LangChain4j | `langchain4j/langchain4j` | 10,784 | No |
| 11 | Sagents | `sagents-ai/sagents` | 103 | Yes (Elixir strategic benchmark) |
