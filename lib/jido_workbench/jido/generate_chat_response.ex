defmodule JidoWorkbench.Actions.GenerateChatResponse do
  require Logger
  ...
  use Jido.Action,
    ...
    schema: [
      ...
      available_commands: [type: {:list, :map}, required: true, doc: "List of available commands"]
    ]

  def run(params, context) do
    Logger.metadata(action: "generate_chat_response", context: context)
