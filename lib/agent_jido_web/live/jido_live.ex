# defmodule AgentJidoWeb.JidoLive do
#   use AgentJidoWeb, :live_view
#   import AgentJidoWeb.WorkbenchLayout
#   alias AgentJido.AgentJido
#   alias Jido.Chat.{Message, Participant, Room}
#   alias Jido.Chat
#   require Logger

#   @agent_id Application.compile_env(:agent_jido, [:agent_jido, :agent_id])
#   @room_id Application.compile_env(:agent_jido, [:agent_jido, :room_id])
