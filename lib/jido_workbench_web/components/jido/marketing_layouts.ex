      ...
      <div class="container max-w-[1000px] mx-auto px-6 py-12 md:py-16">
        <div class="grid grid-cols-2 md:grid-cols-6 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li>
                <a href="https://discord.gg/jido" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                  <.discord_icon />
                  Discord
                </a>
              </li>
              <li>
                <a href="https://github.com/agentjido/jido" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                  <.github_icon />
                  GitHub
                </a>
              </li>
              <li>
                <a href="https://x.com/agentjido" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                  <.x_icon />
                  x.com
                </a>
              </li>
              <li>
                <a href="https://linkedin.com/company/jido" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                  <.linkedin_icon />
                  LinkedIn
                </a>
              </li>
              <li>
                <a href="https://youtube.com/@agentjido" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                  <.youtube_icon />
                  YouTube
                </a>
              </li>
