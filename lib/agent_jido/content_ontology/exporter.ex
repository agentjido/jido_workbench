    ...
    examples =
      ...
      |> Enum.map(fn ex ->
        ...
        %{
          ...
          doc_type: nil,
          audience: nil,
          journey_stage: Map.get(ex, :journey_stage),
          content_intent: Map.get(ex, :content_intent),
          capability_theme: Map.get(ex, :capability_theme),
          evidence_surface: Map.get(ex, :evidence_surface),
