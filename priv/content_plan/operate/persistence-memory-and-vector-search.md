%{
  ...
  status: :draft,
  priority: :critical,
  prerequisites: ["operate/agent-server", "reference/configuration"],
  related: ["reference/data-storage-and-pgvector", "reference/configuration", "training/production-readiness"],
