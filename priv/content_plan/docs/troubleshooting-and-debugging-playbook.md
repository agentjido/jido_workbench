%{
  ...
  related: ["docs/telemetry-and-observability", "features/operations-observability", "training/production-readiness", "docs/incident-playbooks"],
  ecosystem_packages: ["agent_jido", "jido"],
  destination_route: "/docs/troubleshooting-and-debugging-playbook",
