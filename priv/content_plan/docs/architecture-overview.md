%{
  ...
  tags: [:docs, :architecture, :foundation, :overview, :hub_reference, :format_markdown, :wave_1],
  ...
  learning_outcomes: ["Map Jido's layered architecture from pure primitives to OTP runtime",
  ...
  related: ["docs/agents", "docs/actions", "docs/signals", "docs/directives", "docs/plugins",
   "ecosystem/package-matrix", "docs/architecture-decision-guides", "build/first-agent"],
  source_files: ["lib/jido.ex", "lib/jido/agent.ex", "lib/jido/agent_server.ex", "lib/jido/agent/directive.ex",
   "lib/jido/agent/strategy.ex", "lib/jido/plugin.ex", "lib/jido/sensor.ex", "lib/jido/signal.ex", "lib/jido/thread.ex",
   "lib/jido/memory.ex", "lib/jido/persist.ex", "lib/jido/discovery.ex", "lib/jido/observe.ex"],
  source_modules: ["Jido", "Jido.Agent", "Jido.AgentServer", "Jido.Agent.Directive", "Jido.Agent.Strategy",
   "Jido.Plugin", "Jido.Sensor", "Jido.Signal", "Jido.Signal.Router", "Jido.Signal.Bus", "Jido.Signal.Dispatch",
   "Jido.Action", "Jido.Exec", "Jido.Thread", "Jido.Memory", "Jido.Persist", "Jido.Discovery", "Jido.Observe",
   "Jido.AI", "Jido.AI.Strategies.ReAct"]
}
---
## Content Brief
