%{
  ...
  related: ["docs/contributors/package-quality-standards",
   "docs/contributors/observability-and-error-reporting-standards",
   "docs/contributors/governance-and-team", "docs/community/_hub"],
  prompt_overrides: %{
    ...
    must_include: ["Code, docs, examples, testing, and community contribution lanes",
     ...
     "Pointer to observability standards when changes touch logging, telemetry, or error contracts"],
