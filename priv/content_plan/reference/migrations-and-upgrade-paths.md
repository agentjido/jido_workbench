%{
  ...
  status: :outline,
  priority: :high,
  prerequisites: ["reference/configuration", "operate/production-readiness-checklist"],
  related: ["operate/long-running-agent-workflows", "operate/mixed-stack-runbooks", "training/production-readiness"],
