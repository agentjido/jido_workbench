...
- Baseline guardrails from [Security and Governance](/docs/security-and-governance).
...
4. Add runtime checks from [Production Readiness Checklist](/docs/production-readiness-checklist) before expanding scope.
