%{
  ...
  hex_status: "2.0.0",
  api_stability: "stable — 2.0 shipped, with ongoing adapter and automation improvements in the 2.x line",
  stub: false,
  support: :maintained,
  limitations: [
    "Adapter behavior can vary across browser/runtime combinations",
